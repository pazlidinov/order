...
def load_image(image_path):
    ...
    # Contrast va brightnessni oshirish
    # alpha = 1.2  # Contrast oshirish uchun
    # beta = 30  # Yorug'lik oshirish uchun
...
def cluster_colors(image, num_clusters):
    ...
    centers = kmeans.cluster_centers_.astype(np.uint8)  # Cluster centers (RGB colors)
